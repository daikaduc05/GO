...
cd "..\GO"
start /B go run simple_udp_agent.go -env=simple_config.env -listen -signaling-url=%SIGNALING_URL%
timeout /t 2 /nobreak > nul

echo Starting Agent 2 (Offerer)...
start /B go run simple_udp_agent.go -env=simple_config2.env -peer-id=agent-001 -signaling-url=%SIGNALING_URL%
...
taskkill /F /IM simple_udp_agent.exe 2>nul
